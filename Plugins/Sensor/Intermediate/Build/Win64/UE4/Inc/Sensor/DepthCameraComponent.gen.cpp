...
// End Cross Module References
	DEFINE_FUNCTION(UDepthCameraComponent::execGenerateImageName)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		*(FString*)Z_Param__Result=P_THIS->GenerateImageName();
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(UDepthCameraComponent::execSaveDepthImage)
	{
		P_GET_PROPERTY(FStrProperty,Z_Param_ImagePath);
		P_FINISH;
		P_NATIVE_BEGIN;
		*(bool*)Z_Param__Result=P_THIS->SaveDepthImage(Z_Param_ImagePath);
		P_NATIVE_END;
	}
	...
	void UDepthCameraComponent::StaticRegisterNativesUDepthCameraComponent()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "GenerateImageName", &UDepthCameraComponent::execGenerateImageName },
			{ "InitializeComponentSettings", &UDepthCameraComponent::execInitializeComponentSettings },
			{ "SaveDepthImage", &UDepthCameraComponent::execSaveDepthImage },
		};
	...
	struct Z_Construct_UFunction_UDepthCameraComponent_GenerateImageName_Statics
	{
		struct DepthCameraComponent_eventGenerateImageName_Parms
		{
			FString ReturnValue;
		};
	...
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UDepthCameraComponent_GenerateImageName_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(DepthCameraComponent_eventGenerateImageName_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UDepthCameraComponent_GenerateImageName_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UDepthCameraComponent_GenerateImageName_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UDepthCameraComponent_GenerateImageName_Statics::Function_MetaDataParams[] = {
		{ "Category", "DepthCamera" },
		{ "ModuleRelativePath", "Public/DepthCameraComponent.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UDepthCameraComponent_GenerateImageName_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UDepthCameraComponent, nullptr, "GenerateImageName", nullptr, nullptr, sizeof(DepthCameraComponent_eventGenerateImageName_Parms), Z_Construct_UFunction_UDepthCameraComponent_GenerateImageName_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UDepthCameraComponent_GenerateImageName_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04040401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UDepthCameraComponent_GenerateImageName_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UDepthCameraComponent_GenerateImageName_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UDepthCameraComponent_GenerateImageName()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UDepthCameraComponent_GenerateImageName_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_UDepthCameraComponent_SaveDepthImage_Statics
	{
		struct DepthCameraComponent_eventSaveDepthImage_Parms
		{
			FString ImagePath;
			bool ReturnValue;
		};
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UDepthCameraComponent_SaveDepthImage_Statics::NewProp_ImagePath_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UDepthCameraComponent_SaveDepthImage_Statics::NewProp_ImagePath = { "ImagePath", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(DepthCameraComponent_eventSaveDepthImage_Parms, ImagePath), METADATA_PARAMS(Z_Construct_UFunction_UDepthCameraComponent_SaveDepthImage_Statics::NewProp_ImagePath_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UDepthCameraComponent_SaveDepthImage_Statics::NewProp_ImagePath_MetaData)) };
	void Z_Construct_UFunction_UDepthCameraComponent_SaveDepthImage_Statics::NewProp_ReturnValue_SetBit(void* Obj)
	{
		((DepthCameraComponent_eventSaveDepthImage_Parms*)Obj)->ReturnValue = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UDepthCameraComponent_SaveDepthImage_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(DepthCameraComponent_eventSaveDepthImage_Parms), &Z_Construct_UFunction_UDepthCameraComponent_SaveDepthImage_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UDepthCameraComponent_SaveDepthImage_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UDepthCameraComponent_SaveDepthImage_Statics::NewProp_ImagePath,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UDepthCameraComponent_SaveDepthImage_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UDepthCameraComponent_SaveDepthImage_Statics::Function_MetaDataParams[] = {
		{ "Category", "DepthCamera" },
		{ "ModuleRelativePath", "Public/DepthCameraComponent.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UDepthCameraComponent_SaveDepthImage_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UDepthCameraComponent, nullptr, "SaveDepthImage", nullptr, nullptr, sizeof(DepthCameraComponent_eventSaveDepthImage_Parms), Z_Construct_UFunction_UDepthCameraComponent_SaveDepthImage_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UDepthCameraComponent_SaveDepthImage_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04040401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UDepthCameraComponent_SaveDepthImage_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UDepthCameraComponent_SaveDepthImage_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UDepthCameraComponent_SaveDepthImage()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UDepthCameraComponent_SaveDepthImage_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UDepthCameraComponent_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UDepthCameraComponent_GenerateImageName, "GenerateImageName" }, // 4116504948
		{ &Z_Construct_UFunction_UDepthCameraComponent_InitializeComponentSettings, "InitializeComponentSettings" }, // 1967026808
		{ &Z_Construct_UFunction_UDepthCameraComponent_SaveDepthImage, "SaveDepthImage" }, // 1079000409
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UDepthCameraComponent, 4230076905);
